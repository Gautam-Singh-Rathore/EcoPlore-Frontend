const AvatarCard = ({ firstName, lastName, mobile, email, createdAt }) => {
  ...
  return (
    <div className="relative bg-white rounded-lg shadow-md w-full p-4 pt-28 sm:px-6 md:px-8 "> {/* increased pt-16 to pt-28 */}
      ...
      <div className="flex justify-between items-start mt-4">
        ...
        <div className="text-right">
          <p className="text-base text-gray-700">{mobile}</p>
        </div>
      </div>
